  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#edeef4]">
      ...
      >
        ...
        {/* brand */}
        <div className={cn("relative flex items-center gap-3 h-[68px] px-4", collapsed && "justify-center px-0")}>
          {collapsed
            ? <NamAstaMark size={34} />
          ...
          {navItems.filter(i => !i.adminOnly || user?.role === "admin").map(item => (
            <NavLink
              ...
              className={({ isActive }) => cn(
                "group relative flex items-center gap-3 rounded-xl px-3 py-3 text-[14px] font-medium transition-all duration-150",
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-[64px] shrink-0 flex items-center gap-4 px-6 glass border-b border-black/[0.05] z-20">
          <h1 className="text-[16px] font-bold text-[#14151c] tracking-tight min-w-0 truncate">
