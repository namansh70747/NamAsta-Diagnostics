      ...
      {!disabled && (
        <>
          ...
          <div className="flex items-center gap-2">
            <span className="text-[11.5px] font-medium text-[#4c4e5d] whitespace-nowrap shrink-0">
              Insert test:
            </span>
            <Combobox
              value={null}
          ...
          <div className="flex items-center gap-1.5 flex-wrap">
            ...
            <button
              ...
              className="w-9 h-9 rounded-lg border border-[#e6e7ee] bg-white text-[13px] text-[#3a3b45] hover:bg-[#fbe5e5] hover:border-[#d27979] hover:text-[#a31e1e] transition-colors"
            >
              ⌫
            </button>
            <button
              ...
              onClick={handleClear}
              className="ml-auto px-3 h-9 rounded-lg border border-[#e6e7ee] bg-white text-[12px] text-[#4c4e5d] hover:bg-[#fbe5e5] hover:text-[#a31e1e] transition-colors"
            >
              Clear
            </button>
          </div>
          ...
          <div className="flex flex-wrap gap-3 items-end">
            {referencedCodes.map(code => (
              <div key={code} className="flex flex-col gap-1">
                <label className="text-[11.5px] font-medium text-[#3a3b45] truncate max-w-[110px]">
            ...
            <div className="flex flex-col gap-1">
              <label className="text-[11.5px] font-medium text-[#4c4e5d]">Result</label>
