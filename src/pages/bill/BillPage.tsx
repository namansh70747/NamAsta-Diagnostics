...
export function BillPage() {
  ...
  if (!patient) {
    return <div className="p-10 text-center text-[14px] text-[#6b6c7e]">Loading bill…</div>;
  }
  ...
  return (
    <div className="flex h-full min-h-0">
      ...
      <aside className="w-[280px] shrink-0 border-l border-[#e6e7ee] bg-white p-4 flex flex-col gap-2 overflow-auto">
        ...
        <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#6b6c7e] mt-1">Bill / Receipt</p>
        ...
        <div className="card p-3 mt-2 space-y-1 text-[13px]">
          <p className="text-[11px] font-semibold uppercase tracking-[0.08em] text-[#6b6c7e] mb-1">Summary</p>
        ...
        {(!patient.phone || !patient.email) && (
          <p className="text-[11px] text-[#82849a] leading-snug mt-1">
