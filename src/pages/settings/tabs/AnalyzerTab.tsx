        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-lg border border-[#d7d8e0] px-2.5 py-1 text-[12px] text-[#3a3b45] hover:bg-[#fafafe] transition-colors"
            >
          ...
          {(() => {
            ...
            return (
              <div className={`text-[12.5px] rounded-lg px-3 py-2 ${got === 3 && inspect.mllpComplete ? 'bg-[#eafaf0] text-[#14743a]' : inspect.imageFieldCount > 0 ? 'bg-[#fdf0d7] text-[#92600a]' : 'bg-[#fafafe] text-[#3a3b45]'}`}>
              ...
              {([['WBC', edImgs.wbcImg], ['RBC', edImgs.rbcImg], ['PLT', edImgs.pltImg]] as const).filter(([, u]) => u).map(([label, url]) => {
                ...
                return (
                  <div key={label} className="rounded-lg border border-[#e6e7ee] p-2 bg-white">
                    ...
                    <div className="mt-1 text-[10.5px] text-[#4c4e5d]">{label} · {bytes.toLocaleString()} B</div>
                  </div>
                );
              })}
            </div>
          ...
          <div>
            <div className="text-[12px] font-semibold uppercase tracking-[0.08em] text-[#4c4e5d] mb-1.5">Hex dump (first 4 KB)</div>
      ...
      {raw && (
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <div className="text-[12px] font-semibold uppercase tracking-[0.08em] text-[#4c4e5d]">Raw output</div>
            <button
              type="button"
              onClick={() => {
