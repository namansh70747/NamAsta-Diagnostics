      ...
      <Card className="space-y-4">
        ...
        <div className="flex items-start justify-between gap-4 rounded-xl border border-[#e6e7ee] bg-[#f7f8fb] px-4 py-3">
          <div>
            ...
            <p className="text-[12px] text-[#4c4e5d] mt-0.5 max-w-md">
              {enabled
        ...
        <div className="flex items-center gap-3 flex-wrap pt-1">
          ...
          <span className="text-[12px] text-[#5e6072]">
            Last backup: <b className="font-semibold text-[#3a3b45]">{lastBackupDate}</b>
          </span>
        </div>
  ...
  return (
    <Card className="space-y-4">
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {chosen && <span className="text-[12px] text-[#3a3b45] font-mono">{chosen}</span>}
      </div>
