...
function ImagePicker({
  ...
  return (
    <div>
      ...
      <div className="text-[12px] text-[#5e6072] -mt-2 mb-3">{description}</div>
      ...
      {value ? (
        ...
        >
          ...
          <div className="text-[13.5px] text-[#3a3b45] font-medium inline-flex items-center gap-1.5">
            <Upload size={14} strokeWidth={1.8} />
            Click to upload, or drag an image here
          </div>
          <div className="text-[12px] text-[#5e6072] mt-1">PNG or JPG, transparent background works best</div>
        </div>
      )}
    </div>
  );
